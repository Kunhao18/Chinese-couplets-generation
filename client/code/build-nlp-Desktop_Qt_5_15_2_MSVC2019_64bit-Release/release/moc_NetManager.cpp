...
QT_MOC_LITERAL(1, 11, 12), // "ReturnResult"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 11) // "ReturnScore"

    },
    "NetManager\0ReturnResult\0\0ReturnScore"
};
...
void NetManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->ReturnScore((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (NetManager::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetManager::ReturnResult)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (NetManager::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetManager::ReturnScore)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void NetManager::ReturnResult(QString _t1)
{
...
// SIGNAL 1
void NetManager::ReturnScore(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
